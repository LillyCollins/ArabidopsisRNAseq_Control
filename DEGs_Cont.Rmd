...
PCoA_plot <- PCoA %>% 
  ...
  labs(x = "Leading logFC dim 1 (48%)",
       ...
       # title = "Multi-dimensioanl scaling (MDS) principal coordinate plot for WT and GABA mutants under control condition (not submerged)"
       ) +
...
mutants <- c("gad1CS","gad1SALK","gad2-1", "gad1245","gad2OE_B33","pop2-8")
...
UpSet(m, 
      ...
      right_annotation = rowAnnotation(
        ...
        #                      location = 1,
        #                      just = "right", height = 2,
        #                      width = max_text_width(set_name(m)) + unit(0.5, "mm"))
        ),
